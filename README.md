...
This fork publishes an unofficial iOS/iPadOS build with optional thermally adaptive real-time Apple MetalFX enhancement, source-FPS frame pacing, customizable text-subtitle size and black-bar positioning, and a background-safe playback sleep timer. Add the following source URL to **AltStore Classic**:
