...
The current build requires macOS 15.6 or later and an Apple silicon Mac. Anime4K Metal enhancement is available with the same Off, Auto, Fast, Balanced, and Quality modes used on iPhone and iPad. Auto remains the recommended mode because display size, source frame rate, power mode, and thermal conditions still affect sustainable quality.
