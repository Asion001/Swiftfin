...
enum MPVStatisticsStrings {
    static let title = String(localized: "mpv.stats.title", defaultValue: "MPV statistics")
    static let decoding = String(localized: "mpv.stats.decoding", defaultValue: "Decoding")
    static let presentation = String(localized: "mpv.stats.presentation", defaultValue: "Presentation")
    static let color = String(localized: "mpv.stats.color", defaultValue: "Color")
    static let tracks = String(localized: "mpv.stats.tracks", defaultValue: "Tracks")
    static let log = String(localized: "mpv.stats.log", defaultValue: "Log")
    static let copyLog = String(localized: "mpv.stats.copy-log", defaultValue: "Copy log")
    static let clearLog = String(localized: "mpv.stats.clear-log", defaultValue: "Clear log")
    static let unavailable = String(localized: "mpv.stats.unavailable", defaultValue: "MPV is not the active player.")
    static let hardwareDecoder = String(localized: "mpv.stats.hwdec", defaultValue: "Hardware decoder")
    static let videoCodec = String(localized: "mpv.stats.video-codec", defaultValue: "Video codec")
    static let pixelFormat = String(localized: "mpv.stats.pixel-format", defaultValue: "Pixel format")
    static let audioCodec = String(localized: "mpv.stats.audio-codec", defaultValue: "Audio codec")
    static let resolution = String(localized: "mpv.stats.resolution", defaultValue: "Resolution")
    static let containerFPS = String(localized: "mpv.stats.container-fps", defaultValue: "Container FPS")
    static let estimatedFPS = String(localized: "mpv.stats.estimated-fps", defaultValue: "Estimated FPS")
    static let displayFPS = String(localized: "mpv.stats.display-fps", defaultValue: "Display FPS")
    static let decoderDrops = String(localized: "mpv.stats.decoder-drops", defaultValue: "Decoder drops")
    static let outputDrops = String(localized: "mpv.stats.output-drops", defaultValue: "Output drops")
    static let cache = String(localized: "mpv.stats.cache", defaultValue: "Demuxer cache")
    static let primaries = String(localized: "mpv.stats.primaries", defaultValue: "Primaries")
    static let transfer = String(localized: "mpv.stats.transfer", defaultValue: "Transfer")
    static let signalPeak = String(localized: "mpv.stats.sig-peak", defaultValue: "Signal peak")
    static let dynamicRange = String(localized: "mpv.stats.dynamic-range", defaultValue: "Dynamic range")
    static let upscaler = String(localized: "mpv.stats.upscaler", defaultValue: "Upscaler")
    static let gpu = String(localized: "mpv.stats.gpu", defaultValue: "GPU")
    static let none = String(localized: "mpv.stats.none", defaultValue: "None")
}
